...
public class PubSubEmulatorProcessFixture
{
    ...
    public IdentityIntelligenceSubscriberConfiguration CreateDefaultSubscriberConfig(string subscriptionId)
    {
        return new IdentityIntelligenceSubscriberConfiguration
        {
